...
class ConnectRedirectControllerTest extends TestCase
{
    /**
    ...
    private ConnectRedirectController $controller;
    ...
    protected function setUp(): void
    {
        ...
        $this->controller = new ConnectRedirectController(
            $this->corpRepository,
            $this->agentRepository
        );
    }

    public function testInvoke_withValidCorpAndAgent_redirectsToWechatOAuth(): void
    {
        $request = new Request();
        ...
        $controllerClass = new class($this->corpRepository, $this->agentRepository) extends ConnectRedirectController {
            public string $generatedUrl = '';
            public string $redirectUrl = '';
            
            protected function generateUrl(string $route, array $parameters = [], int $referenceType = UrlGeneratorInterface::ABSOLUTE_PATH): string
            {
                $this->generatedUrl = 'https://myapp.com/wechat/work/connect-callback/corp123/agent456?callbackUrl=https://example.com/callback';
        ...
        $this->assertStringStartsWith('https://open.weixin.qq.com/connect/oauth2/authorize?', $controllerClass->redirectUrl);
        ...
        $this->assertStringContainsString('response_type=code', $controllerClass->redirectUrl);
        $this->assertStringContainsString('scope=snsapi_privateinfo', $controllerClass->redirectUrl);
        $this->assertStringContainsString('#wechat_redirect', $controllerClass->redirectUrl);
