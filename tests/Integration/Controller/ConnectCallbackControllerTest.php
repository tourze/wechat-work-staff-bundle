...
class ConnectCallbackControllerTest extends TestCase
{
    /**
    ...
    private ConnectCallbackController $controller;
    ...
    protected function setUp(): void
    {
        ...
        $this->controller = new ConnectCallbackController(
            $this->codeApi,
            $this->noticeService,
            $this->twig
        );
    ...
    public function testInvoke_withCallbackUrl_redirectsToRenderedUrl(): void
    {
        ...
        $request->query->set('callbackUrl', 'https://example.com/connect?jwt={{ jwt }}');
        ...
        $controller = new ConnectCallbackController(
            $this->codeApi,
            $this->noticeService,
            $twig
        );
        ...
        $this->assertEquals('https://example.com/connect?jwt=test-jwt-token', $response->getTargetUrl());
    }
