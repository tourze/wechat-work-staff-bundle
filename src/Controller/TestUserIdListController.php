...
final class TestUserIdListController extends AbstractController
{
    ...
    #[Route(path: '/wechat/work/test/get_user_id_list', name: 'wechat_work_test_user_id_list', methods: ['GET', 'POST'])]
